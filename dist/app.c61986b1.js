...
function fetchPosts(page) {
  ...
  return __awaiter(this, void 0, Promise, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, fetch("/api/posts?page=".concat(page))];
        case 1:
          response = _a.sent();
...
function fetchPostById(id) {
  return __awaiter(this, void 0, Promise, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, fetch("/api/posts/".concat(id))];
        case 1:
          response = _a.sent();
          return [4 /*yield*/, response.json()];
        case 2:
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          _a.trys.push([0, 2,, 3]);
          return [4 /*yield*/, fetchPosts(1)];
        case 1:
          response = _a.sent();
          // Те TypeScript ЗНАЕТ структуру response!
          console.log("\u0412\u0441\u0435\u0433\u043E \u043F\u043E\u0441\u0442\u043E\u0432: ".concat(response.total));
          console.log("\u0421\u0442\u0440\u0430\u043D\u0438\u0446\u0430 ".concat(response.page, " \u0438\u0437 ").concat(response.totalPages));
          // response.data - это Массив Post[]
          response.data.forEach(function (post) {
            // TypeScript знает, что post имеет поля title, author и т.д.
            console.log("\u041F\u043E\u0441\u0442: ".concat(post.title, ", \u0410\u0432\u0442\u043E\u0440: ").concat(post.author.name));
          });
          return [3 /*break*/, 3];
        case 2:
          error_1 = _a.sent();
...
},{}]},{},["../../../../Users/Zam/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app.ts"], null)
